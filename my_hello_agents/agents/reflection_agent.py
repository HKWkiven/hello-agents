...
RECORD_TYPE = Literal["execution", "reflection"]
...
class Memory:
    ...
    def add_record(self, record_type: RECORD_TYPE, content: str):
        """向记忆中添加一条新记录"""
...
class ReflectionAgent(Agent):
    ...
    def __init__(
        ...
        Args:
            ...
            custom_prompts: 自定义提示模板 {"initial": "", "reflect": "", "refine": ""}
        """
