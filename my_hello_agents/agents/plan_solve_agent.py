...
@日期: 2025/11/6 08:38
@作者: HKW
@说明: Plan and Solve Agent实现 - 分解规划与逐步执行的智能体
"""
...
from my_hello_agents import Agent, HelloAgentsLLM, Config, Message
...
class Planner:
    ...
    def __init__(
            ...
            prompte_template: Optional[str] = None
    ):
        self.llm_client = llm_client
        self.prompt_template = prompte_template if prompte_template else DEFAULT_PLANNER_PROMPT
    ...
    def plan(self, question: str, **kwargs) -> List[str]:
        ...
        messages = [Message("user", prompt).to_dict()]
        print("--- 正在生成计划 ---")
